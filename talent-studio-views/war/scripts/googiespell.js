...
GoogieSpell.escapeSepcial = function(val) {
    var escapedChars=val.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
    return escapedChars;
}
...
//    return '<?xml version="1.0" encoding="utf-8" ?><spellrequest textalreadyclipped="0" ignoredups="0" ignoredigits="1" ignoreallcaps="1"><text><![CDATA["' + text + '"]]></text></spellrequest>';
}
...
GoogieSpell.prototype.createSpellDiv = function() {
    ...
    if(this.show_spell_img)
        ...
        spell_img.className="spellClass";
