...
<fmt:message key="subject.association.title" var="boxtitle"/>
        ...
        <tr>
            <td class="infodata">
                <table class="pager" cellspacing="0">
                    <thead>
                        <tr>
                            <th class="sorted"><fmt:message key="generic.name"/></th>
                    ...
                    <c:forEach var="assoc" items="${command.unassignedAssociations}" varStatus="status" >
                        <tr>
                            <td class="infolabel">
                                <c:out value="${assoc.subject.firstName}"/>&nbsp;<c:out value="${assoc.subject.secondName}"/>
                            </td>
                            <td class="infodata">
                    ...
                    <tr>
                        <td class="infolabel">
                            <c:out value="${assignedAssoc.subject.firstName}"/>&nbsp;<c:out value="${assignedAssoc.subject.secondName}"/>
                        </td>
                        <td class="infodata">
