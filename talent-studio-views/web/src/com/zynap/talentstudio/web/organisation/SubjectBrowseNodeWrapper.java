 ...
 */
public class SubjectBrowseNodeWrapper extends BrowseNodeWrapper {

    public SubjectBrowseNodeWrapper(NodeSearchQueryWrapper queryWrapper, List results, SubjectWrapperBean nodeWrapperBean) {
