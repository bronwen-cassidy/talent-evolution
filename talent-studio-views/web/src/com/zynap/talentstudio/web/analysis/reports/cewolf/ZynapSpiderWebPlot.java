 ...
 */
public class ZynapSpiderWebPlot extends SpiderWebPlot implements Cloneable, Serializable {
     ...
     */
    public ZynapSpiderWebPlot(CategoryDataset dataset) {
        super(dataset);
     ...
     * @param type controls how data is extracted ({@link TableOrder#BY_ROW}
     *                or {@link TableOrder#BY_COLUMN}).
     */
    public ZynapSpiderWebPlot(CategoryDataset data, TableOrder type) {
        this(data);
                     ...
                     PlotRenderingInfo info)
    {
        ...
        if (!DatasetUtilities.isEmptyOrNull(this.dataset)) {
            ...
            for (int cat = 0; cat < catCount; cat++) {
                ...
                g2.setStroke(DEFAULT_LABEL_OUTLINE_STROKE);
                g2.draw(line);

                drawLabel(g2, radarArea, 0.0, cat, angle, 360.0 / catCount);
            }

            // reset the psint and stroke
    ...
    protected void drawRadarPoly(Graphics2D g2,
        ...
        EntityCollection entities = null;//new StandardEntityCollection();
        if (info != null) {
            ...
            if (dataValue != null) {
                ...
                if (value >= 0) { // draw the polygon series...
                    ...
                    if (entities != null) {
                        ...
                        CategoryItemEntity entity = new CategoryItemEntity(area, tip, url, this.dataset, row, this.dataset.getColumnKey(col), col);
                        entities.add(entity);
                    }
