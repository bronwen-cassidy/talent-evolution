 ...
 * Time: 15:26:14
 */
public final class InvalidDataExceptionHandler implements ExceptionHandler {
    ...
    public void handle(DetailEntry entry, Throwable t, SOAPFactory soapFactory) throws SOAPException {
        ...
        entry.setAttribute(IntegrationConstants.CODE_ATTRIBUTE, IntegrationConstants.INVALID_DATA_CODE);
