 ...
 * -Dtest.db.url=jdbc:oracle:thin:@sunserver:1521:oradb -Dtest.db.username=tsdev -Dtest.db.password=tsdev -Dtest.base.url=http://localhost:7001/talent-studio -Dautonomy.indexport=9001 -Dautonomy.aciport=9002   -Dautonomy.position.database=positiondata -Dautonomy.subject.database=subjectdata -Dautonomy.retries=3 -Dautonomy.connection.timeout=5000 -Dautonomy.searcher=mockAutonomySearcher -Dsender.email=bcassidy@zynap.com -Dtest.webservice.username=webserviceuser -Dtest.webservice.password=webserviceuser -Dsearch.engine=autonomy
 *
 * live server properties
 * -Dtest.db.url=jdbc:oracle:thin:@10.83.110.118:1521:ZYNTS01 -Dtest.db.username=TS3 -Dtest.db.password=TS3 -Dtest.base.url=http://localhost:7001/talent-studio -Dautonomy.indexport=9001 -Dautonomy.aciport=9002   -Dautonomy.position.database=positiondata -Dautonomy.subject.database=subjectdata -Dautonomy.retries=3 -Dautonomy.connection.timeout=5000 -Dautonomy.searcher=mockAutonomySearcher -Dsender.email=bcassidy@zynap.com -Dtest.webservice.username=webserviceuser -Dtest.webservice.password=webserviceuser -Dsearch.engine=autonomy
 *
