...
insert into permits_roles select id, '8' from permits where url like '%talentarena%' and url not like '%editmy%' and url not like '%viewmy%' AND type = 'AP';
...
insert into permits_roles select id, '8' from permits where url like '%viewmy%' AND type = 'AP';
insert into permits_roles select id, '8' from permits where url like '%myobjective%' AND type = 'AP';
insert into permits_roles select id, '8' from permits where url like '%myoportfolio%' AND type = 'AP';
insert into permits_roles select id, '8' from permits where url like '%deletemy%' AND type = 'AP';
