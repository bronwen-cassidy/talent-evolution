 ...
 *     
*/
public class PositionsHierarchyInc implements Serializable {
    ...
    /** full constructor */
    public PositionsHierarchyInc(PositionsHierarchyPK comp_id, Integer hlevel,  Position positionById, Position positionByRootId) {        this.comp_id = comp_id;
        this.hlevel = hlevel;
    ...
    /** default constructor */
    public PositionsHierarchyInc() {
    }

    /** minimal constructor */
    public PositionsHierarchyInc(PositionsHierarchyPK comp_id) {
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof PositionsHierarchyInc) ) return false;
        PositionsHierarchyInc castOther = (PositionsHierarchyInc) other;
