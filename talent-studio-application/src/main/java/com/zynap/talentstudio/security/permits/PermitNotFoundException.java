...
/**
 * Exception generated when an asked for permission has not been found
 *
 * @author bcassidy
 * @version $Revision: $
 *          $Id: $
 */
public class PermitNotFoundException extends TalentStudioRuntimeException {
     ...
     * @since 1.4
     */
    public PermitNotFoundException(Throwable cause) {
        super(cause);
    }
